...
_INSTRUMENTATIONSCOPE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='attributes', full_name='opentelemetry.proto.common.v1.InstrumentationScope.attributes', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='dropped_attributes_count', full_name='opentelemetry.proto.common.v1.InstrumentationScope.dropped_attributes_count', index=3,
...
_ENTITYREF = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='schema_url', full_name='opentelemetry.proto.common.v1.EntityRef.schema_url', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='type', full_name='opentelemetry.proto.common.v1.EntityRef.type', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='id_keys', full_name='opentelemetry.proto.common.v1.EntityRef.id_keys', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='description_keys', full_name='opentelemetry.proto.common.v1.EntityRef.description_keys', index=3,
...
_INSTRUMENTATIONSCOPE.fields_by_name['attributes'].message_type = _KEYVALUE

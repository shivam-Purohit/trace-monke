...
_RESOURCE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='entity_refs', full_name='opentelemetry.proto.resource.v1.Resource.entity_refs', index=2,
...
_RESOURCE.fields_by_name['entity_refs'].message_type = opentelemetry_dot_proto_dot_common_dot_v1_dot_common__pb2._ENTITYREF
